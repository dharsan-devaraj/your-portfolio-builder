    ...
    <section ref={containerRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-background pt-20">
      ...
      <div className="container relative z-10 px-6 flex-1 flex flex-col justify-center">
        <div className="max-w-full mx-auto w-full">
          ...
          <div className="mb-12">
            {/* FULL — STACK line */}
            <h1 className="text-[clamp(3rem,12vw,10rem)] font-bold leading-[0.9] tracking-[-0.03em] overflow-hidden">
            ...
            <h1 className="text-[clamp(3rem,12vw,10rem)] font-bold leading-[0.9] tracking-[-0.03em] overflow-hidden -mt-2">
